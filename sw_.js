...
self.addEventListener("fetch", (event) => {
    ...
    if (requestUrl.pathname.startsWith('/raa/')) {
        // Si la requête concerne une ressource sous /raa/, elle peut être traitée normalement.
        event.respondWith(
        ...
        // Gestion d'autres ressources si nécessaire.
